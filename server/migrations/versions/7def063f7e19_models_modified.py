...
Revision ID: 7def063f7e19
Revises: a50cde241c4b
Create Date: 2023-09-04 20:23:41.085723
...
def upgrade():
    ...
    with op.batch_alter_table('baked_goods', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('bakery', sa.String(length=50), nullable=False))
